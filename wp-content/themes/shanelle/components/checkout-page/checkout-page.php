	...
	<div class="checkout-page__layout">
		...
		>
			<div class="checkout-page__main">
				<?php CheckoutPage::render_express_payments(); ?>
		...
		<?php
		/*
		 * Coupon stays outside the checkout form (nested forms are invalid).
		 * Placed after the form in DOM; CSS puts it after the summary so it
		 * does not interrupt the path to payment / place order.
		 */
		CheckoutPage::render_coupon();
		?>
	</div>

	<?php CheckoutPage::render_sticky_place_order(); ?>
