...
/**
 * Swap min/max when the range is inverted (graceful, no extra UI chrome).
 *
 * @param {HTMLFormElement} form
 */
function normalizePriceInputs( form ) {
	const minInput = form.querySelector( 'input[name="shanelle_filter_min_price"]' );
	const maxInput = form.querySelector( 'input[name="shanelle_filter_max_price"]' );
...
export { initCatalogFilters, normalizePriceInputs };
