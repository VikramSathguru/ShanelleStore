...
define( 'SHANELLE_VERSION', '1.0.15' );
...
require_once SHANELLE_DIR . '/inc/components/AboutPage.php';
require_once SHANELLE_DIR . '/inc/components/PageHero.php';
require_once SHANELLE_DIR . '/inc/components/InfoPage.php';
require_once SHANELLE_DIR . '/inc/components/SiteHeader.php';
require_once SHANELLE_DIR . '/inc/components/Footer.php';
require_once SHANELLE_DIR . '/inc/components/FooterBrand.php';
require_once SHANELLE_DIR . '/inc/components/FooterLinks.php';
require_once SHANELLE_DIR . '/inc/components/FooterCustomerService.php';
