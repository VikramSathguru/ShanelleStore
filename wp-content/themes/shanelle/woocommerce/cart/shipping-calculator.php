...
<form class="woocommerce-shipping-calculator cart-page__shipping-form" action="<?php echo esc_url( wc_get_cart_url() ); ?>" method="post">
	...
	<section class="shipping-calculator-form cart-page__shipping-panel" id="shipping-calculator-form" style="display:none;">
		...
		<?php if ( apply_filters( 'woocommerce_shipping_calculator_enable_country', true ) ) : ?>
			<p class="form-row form-row-wide cart-page__shipping-field" id="calc_shipping_country_field">
				...
				<select name="calc_shipping_country" id="calc_shipping_country" class="country_to_state country_select cart-page__shipping-input" data-input-classes="cart-page__shipping-input" rel="calc_shipping_state">
		...
		<?php if ( apply_filters( 'woocommerce_shipping_calculator_enable_state', true ) ) : ?>
			<p class="form-row form-row-wide cart-page__shipping-field" id="calc_shipping_state_field">
				...
				if ( is_array( $states ) && empty( $states ) ) {
					?>
					<input type="hidden" name="calc_shipping_state" id="calc_shipping_state" data-input-classes="cart-page__shipping-input" />
					<?php
				} elseif ( is_array( $states ) ) {
					?>
					<label class="text-label" for="calc_shipping_state"><?php esc_html_e( 'State / County', 'woocommerce' ); ?></label>
					<select name="calc_shipping_state" class="state_select cart-page__shipping-input" data-input-classes="cart-page__shipping-input" id="calc_shipping_state">
					...
					?>
					<label class="text-label" for="calc_shipping_state"><?php esc_html_e( 'State / County', 'woocommerce' ); ?></label>
					<input type="text" class="input-text cart-page__shipping-input" data-input-classes="cart-page__shipping-input" value="<?php echo esc_attr( $current_r ); ?>" name="calc_shipping_state" id="calc_shipping_state" />
					<?php
				}
				?>
			</p>
